...
export const Sidebar = ({ activeTab, setActiveTab, onLogout }) => {
  ...
  return (
    <aside className="w-72 bg-neutral-900 text-white flex flex-col sticky top-0 h-screen border-r border-white/5 z-50 shadow-2xl">
      {/* 🚀 Step 1: Reduced top padding and logo margin slightly */}
      <div className="p-6 pb-2">
        ...
        {/* 🚀 Step 2: Slightly tighter spacing for Nav Links */}
      ...
      {/* 🚀 Step 3: Centered Logout Button with justify-center */}
      <div className="mt-auto p-6 border-t border-white/5">
        <button
          onClick={onLogout}
          className="w-full flex items-center justify-center gap-3 px-4 py-3.5 bg-red-500/10 text-red-500 hover:bg-red-500 hover:text-white transition-all rounded-xl font-black text-[11px] uppercase tracking-widest active:scale-95"
        >
