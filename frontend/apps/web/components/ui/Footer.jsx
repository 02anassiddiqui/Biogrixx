...
const navigation = {
  ...
  support: [
    ...
    { label: 'Infrastructure Support', href: '/support' },
...
export function Footer() {
  return (
    <footer className="bg-neutral-900 text-neutral-400 border-t border-neutral-900">
      <div className="max-w-7xl mx-auto px-6 pt-20 pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="flex gap-4">
              <a href="#" className="p-2 rounded-lg bg-neutral-900 hover:text-primary transition-colors"><Twitter size={18} /></a>
              <a href="#" className="p-2 rounded-lg bg-neutral-900 hover:text-primary transition-colors"><Linkedin size={18} /></a>
              <a href="#" className="p-2 rounded-lg bg-neutral-900 hover:text-primary transition-colors"><Github size={18} /></a>
            </div>
          </div>
          ...
          <div className="lg:col-span-6 grid grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div>
              <h4 className="text-white text-xs font-black uppercase tracking-[0.2em] mb-6">Resources</h4>
              <ul className="space-y-4">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="p-4 bg-neutral-900/50 border border-neutral-800 rounded-2xl">
              ...
              <p className="text-[10px] text-neutral-500 leading-relaxed font-medium">
                All monitoring nodes active across global plants.
              </p>
            </div>
          </div>
        </div>
        ...
        {/* --- BOTTOM BAR --- */}
        <div className="pt-8 border-t border-neutral-900 flex flex-col md:flex-row items-center justify-between gap-6">
